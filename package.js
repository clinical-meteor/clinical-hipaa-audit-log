...
Package.on_use(function (api) {
  ...
  api.use('clinical:hipaa-logger@2.0.5');
  api.use('clinical:glass-ui@2.4.1');
  ...
  api.use('clinical:hl7-resource-audit-event@1.6.6');

  api.imply('clinical:hipaa-logger@2.0.5');
